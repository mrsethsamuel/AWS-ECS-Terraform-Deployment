...
variable "example_api_secrets_dev" {
  ...
  default = {
    ...
    DATABASE_HOST                = "your-secret-id-for-DATABASE_HOST",
    REDIS_KEY_PREFIX             = "your-secret-id-for-REDIS_KEY_PREFIX",
    DEFAULT_TIMEZONE             = "your-secret-id-for-DEFAULT_TIMEZONE",
    JWT_ISSUER                   = "your-secret-id-for-JWT_ISSUER",
    RABBITMQ_PASSWORD            = "your-secret-id-for-RABBITMQ_PASSWORD",
    HTTP_PORT                    = "your-secret-id-for-HTTP_PORT",
    USER_JWT_SECRET              = "your-secret-id-for-USER_JWT_SECRET",
    GOOGLE_SECRET_KEY            = "your-secret-id-for-GOOGLE_SECRET_KEY",
    RABBITMQ_TLS                 = "your-secret-id-for-RABBITMQ_TLS",
    RABBITMQ_PORT                = "your-secret-id-for-RABBITMQ_PORT",
    PAYSTACK_API_TOKEN           = "your-secret-id-for-PAYSTACK_API_TOKEN",
    ADMIN_JWT_SECRET             = "your-secret-id-for-ADMIN_JWT_SECRET",
    GOOGLE_CALLBACK_URL          = "your-secret-id-for-GOOGLE_CALLBACK_URL",
    RABBITMQ_KEY_PREFIX          = "your-secret-id-for-RABBITMQ_KEY_PREFIX",
    ALLOWED_LOGIN_ATTEMPTS       = "your-secret-id-for-ALLOWED_LOGIN_ATTEMPTS",
    SERVICE_NAME                 = "your-secret-id-for-SERVICE_NAME",
    DATABASE_NAME                = "your-secret-id-for-DATABASE_NAME",
    RABBITMQ_USERNAME            = "your-secret-id-for-RABBITMQ_USERNAME",
    PRICE_PER_COIN_IN_KOBO       = "your-secret-id-for-PRICE_PER_COIN_IN_KOBO",
    FRONTEND_BASE_URL            = "your-secret-id-for-FRONTEND_BASE_URL",
    GOOGLE_CLIENT_ID             = "your-secret-id-for-GOOGLE_CLIENT_ID",
    IDENTITY_PASS_APP_ID         = "your-secret-id-for-IDENTITY_PASS_APP_ID",
    CLOUDINARY_API_SECRET        = "your-secret-id-for-CLOUDINARY_API_SECRET",
    IDENTITY_PASS_API_TOKEN      = "your-secret-id-for-IDENTITY_PASS_API_TOKEN",
    FACEBOOK_CALLBACK_URL        = "your-secret-id-for-FACEBOOK_CALLBACK_URL",
    IDENTITY_PASS_API_BASE_URL   = "your-secret-id-for-IDENTITY_PASS_API_BASE_URL",
    JWT_EXPIRY_TIME              = "your-secret-id-for-JWT_EXPIRY_TIME",
    CLOUDINARY_API_KEY           = "your-secret-id-for-CLOUDINARY_API_KEY",
    FACEBOOK_SECRET_KEY          = "your-secret-id-for-FACEBOOK_SECRET_KEY",
    FACEBOOK_CLIENT_ID           = "your-secret-id-for-FACEBOOK_CLIENT_ID",
    GIFTING_THRESHOLD_HOURS      = "your-secret-id-for-GIFTING_THRESHOLD_HOURS",
    RABBITMQ_VHOST               = "your-secret-id-for-RABBITMQ_VHOST",
    NODE_ENV                     = "your-secret-id-for-NODE_ENV",
    PAYSTACK_API_BASE_URL        = "your-secret-id-for-PAYSTACK_API_BASE_URL",
    PAYSTACK_MERCHANT_PUBLIC_KEY = "your-secret-id-for-PAYSTACK_MERCHANT_PUBLIC_KEY",
    RABBITMQ_HOST                = "your-secret-id-for-RABBITMQ_HOST",
    CLOUDINARY_NAME              = "your-secret-id-for-CLOUDINARY_NAME",
    DATABASE_PASSWORD            = "your-secret-id-for-DATABASE_PASSWORD",
    DATABASE_USER                = "your-secret-id-for-DATABASE_USER",
    REDIS_URL                    = "your-secret-id-for-REDIS_URL"
  }
}
